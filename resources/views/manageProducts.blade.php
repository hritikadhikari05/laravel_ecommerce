...
<div class="px-10 sm:ml-64">
    <div class="my-10 text-4xl ">Product Management</div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <!-- Loop through the products and display them here -->
                @foreach($products as $product)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="w-32 p-4">
                        <img src="{{asset('storage/'.$product->image_path) }}" alt="Apple Watch">
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <input type="number" id="first_product" class="bg-gray-50 w-14 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{$product->stockQuantity}}" required>
                            </div>
